...
import { LTO_NAV_LINKS } from '@collections/lto-links.collection';

export class LtoNavLink {
...
@Component({
  selector: 'app-lto-navbar',
  templateUrl: './lto-navbar.component.html',
  styleUrls: ['./lto-navbar.component.scss']
})
export class LtoNavbarComponent implements OnChanges {
