...
import { PAYTRONIX_NAV_LINKS } from '@collections/paytronix-links.collection';

export class PaytronixNavLink {
...
@Component({
  selector: 'app-paytronix-navbar',
  templateUrl: './paytronix-navbar.component.html',
  styleUrls: ['./paytronix-navbar.component.scss']
})
export class PaytronixNavbarComponent implements OnChanges {

  @Input('appRoute') appRoute: string;

  public shownNavLinks: LtoNavLink[] = [];
  public untouchedNavLinks: LtoNavLink[] = [];
  public user = '';
  ...
  private setShownNavLinks(): void {
    ...
    PAYTRONIX_NAV_LINKS.forEach((navLink) => {
