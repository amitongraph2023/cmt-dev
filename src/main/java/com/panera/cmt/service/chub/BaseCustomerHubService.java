...
@Service
@Slf4j
public abstract class BaseCustomerHubService {
    ...
    protected <T> ResponseHolder<T> doDelete(Class<T> clazz, StopWatch stopWatch, Audit audit, ChubEndpoints stub, Object... params) {
        return doSendResponse(clazz, stopWatch, audit, HttpMethod.DELETE, null, stub, params);
    }

    protected <T> T doGet(Class<T> clazz, StopWatch stopWatch, ChubEndpoints stub, Object... params) {
        return doSend(clazz, stopWatch, HttpMethod.GET, null, stub, params);
    }

    protected <T> ResponseHolder<T> doGetResponse(Class<T> clazz, StopWatch stopWatch, ChubEndpoints stub, Object... params) {
        return doSendResponse(clazz, stopWatch, null, HttpMethod.GET, null, stub, params);
    }

    protected <T> ResponseHolder<T> doPost(Class<T> clazz, StopWatch stopWatch, Audit audit, Object body, ChubEndpoints stub, Object... params) {
        return doSendResponse(clazz, stopWatch, audit, HttpMethod.POST, body, stub, params);
    }

    protected <T> ResponseHolder<T> doPut(Class<T> clazz, StopWatch stopWatch, Audit audit, Object body, ChubEndpoints stub, Object... params) {
        return doSendResponse(clazz, stopWatch, audit, HttpMethod.PUT, body, stub, params);
    }

    private <T> ResponseHolder<T> doSendResponse(Class<T> clazz, StopWatch stopWatch, Audit audit, HttpMethod method, Object body, ChubEndpoints stub, Object... params) {
    ...
    private <T> T doSend(Class<T> clazz, StopWatch stopWatch, HttpMethod method, Object body, ChubEndpoints stub, Object... params) {
        ProxyUserDTO proxyUserDTO = ProxyUserDTO.fromAuthenticatedUser(AuthenticatedUserManager.getAuthenticatedUser());
        WebClient client = WebClient
                .builder()
                .baseUrl(baseUrl)
