...
@Service
@Slf4j
public class ChubAppConfigService extends BaseCustomerHubService implements IAppConfigService {

    private AppConfigDomain domain = AppConfigDomain.CHUB;
    ...
    public Optional<ResponseHolder<AppConfig>> createAppConfig(AppConfig appConfig) {
        ...
        return Optional.ofNullable(doPost(AppConfig.class, stopWatch, null, AppConfigDTO.fromEntity(appConfig), ChubEndpoints.APP_CONFIG_BASE));
    }
    ...
    public Optional<ResponseHolder<Boolean>> deleteAppConfigById(Long id) {
        ...
        ResponseHolder<Boolean> response = doDelete(Boolean.class, stopWatch, null, ChubEndpoints.APP_CONFIG_BY_ID, id);
    ...
    public Optional<ResponseHolder<Page<AppConfig>>> searchAppConfigPaged(String query, Integer pageNumber, Integer pageSize, Sort.Direction dir, AppConfigSortColumn col) {
        ...
        ResponseHolder<String> response =  doGetResponse(String.class, stopWatch, ChubEndpoints.APP_CONFIG_PAGE, col, dir, pageNumber, query, pageSize);
    ...
    public Optional<ResponseHolder<AppConfig>> updateAppConfig(Long id, AppConfig updatedEntity) {
        ...
        return Optional.ofNullable(doPut(AppConfig.class, stopWatch, null, updatedEntity, ChubEndpoints.APP_CONFIG_BY_ID, id));
    }
